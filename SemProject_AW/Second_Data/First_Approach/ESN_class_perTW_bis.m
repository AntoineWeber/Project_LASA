...
% divide the data into 5 sets and crossvalidate
...
for f_fold=1:1:nblock %5-fold crossvalidation
    ...
    % the remaining fold taken as test data
    ...
    [scores{numb}{f_fold}, err_test{numb}{f_fold}, err_train{numb}{f_fold},con_test{numb}{f_fold},con_train{numb}{f_fold}] = doESN_perTW(train_data,train_labels,test_data,test_labels,numb_TW,nb_hidden,numb,spectralradius,'train');
...
title('Accuracy of an ESN through time')
xlabel('Time [ms]');
ylabel('Accuracy [%]')
