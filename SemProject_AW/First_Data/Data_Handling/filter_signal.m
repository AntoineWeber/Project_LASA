function [filtered_sign,filtered_trig,filtered_labels,filtered_apertures,filtered_indices] = filter_signal(signal,triggers,penaltymin,penaltymax,labels,apertures,indices)
