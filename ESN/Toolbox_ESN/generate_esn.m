function esn = generate_esn(spectralradius, nInputUnits, nInternalUnits, nOutputUnits, varargin)
...
esn.outputActivationFunction = 'sigmoid01';       % options: identity or tanh or sigmoid01
...
esn.spectralRadius = spectralradius ; 
